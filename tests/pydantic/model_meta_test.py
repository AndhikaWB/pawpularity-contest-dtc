...
from pawpaw.pydantic_.server import ServerConf
...
class TestMetadata:
    ...
    def test_model_registration_tags(self):
    ...
    def test_server_config(self):
        compare_metadata(S3Conf, ServerConf)
    
    def test_orchestration_config(self):
        compare_metadata(S3Conf, DeployConf)